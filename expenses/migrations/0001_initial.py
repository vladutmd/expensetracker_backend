    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_type', models.CharField(choices=[('P', 'Physical'), ('E', 'Electronic')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('E', 'Expense'), ('I', 'Income')], max_length=1)),
                ('recurring', models.BooleanField()),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='expenses.category')),
                ('retailer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='expenses.retailer')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
